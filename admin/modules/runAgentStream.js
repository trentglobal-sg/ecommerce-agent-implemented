...
const { takePendingApproval, buildResumeDecisions } = require("./approval")
...
// Resumes a PAUSED run: pops the pending approval, issues a resume
// Command on the same thread, and hands off to the same StreamingAgent
async function resumeAgentStream(
    ...
    const history =
        new MariaDBChatHistory(sessionId);
